// Sample configuration file for Futura Group 3DRAG
// tested on 3DRAG with VM8201 (Display) and LDM extruder v3
// last edited by Andrea Mantelli, 2020-06-12
...
#define STRING_CONFIG_H_AUTHOR "(3Drag LDM, Andrea Mantelli)" // Who made the changes.
...
#define INVERT_E0_DIR false // K8200: true for geared default extruder!
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {64.25,64.25,2560, 400}  // default steps per unit for K8200, 400 E step for LDM extruder
#define DEFAULT_MAX_FEEDRATE          {100, 100, 5, 25}    // lowered max feedrates from {500, 500, 5, 500} (mm/sec)
